...
public class DialogCloneWarrior extends JDialog {
    ...
    public DialogCloneWarrior(MenuScreen parent, Warrior warrior) {
        super(parent.manager, "Clonar Guerrero", true);
        this.parent = parent;
        setSize(400, 300);
        ...
        Label labelTitle = new Label("Clonar Guerrero", SwingConstants.CENTER);
        ...
        isGreek = warrior instanceof Greek;
        JButton buttonType = new JButton(isGreek ? "Griego" : "Troyano");
        ...
        textFieldOld = new PlaceholderTextField(warrior.getOld().toString());
        textFieldOld.setEnabled(false);
        gbc.gridx = 2;
        gbc.gridy = 2;
        gbc.gridwidth = 2;
        add(textFieldOld, gbc);

        textFieldStrength = new PlaceholderTextField(warrior.getStrength().toString());
    ...
    public void create(){
        ...
        int old = Integer.parseInt(textFieldOld.getText());
        int strength = Integer.parseInt(textFieldStrength.getText());
